...
public class ServicioGPS extends Service implements GoogleApiClient.ConnectionCallbacks,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification.Builder constructorNotificacion = new Notification.Builder(ServicioGPS.this).setSmallIcon(R.drawable.marca).setContentTitle("Marcando Posiciones").setContentText("Servicio Activo").setContentIntent(
    ...
    public void onLocationChanged(Location location) {
        ...
        pos.setFecha(d);
        bd.insertar(pos);
        Toast toast = Toast.makeText(this,"Latitud:"+pos.getLatitud()+"Longitud:"+pos.getLongitud(), Toast.LENGTH_LONG);
        toast.show();
        bd.close();
    }
